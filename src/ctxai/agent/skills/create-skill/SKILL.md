...
mkdir -p /ctxai/data/usr/skills/my-skill/{scripts,templates,docs}
```
...
1. Create skill directory:
   ```bash
   mkdir -p /ctxai/data/usr/skills/my-skill
   ```

2. Create SKILL.md:
   ```bash
   touch /ctxai/data/usr/skills/my-skill/SKILL.md
   ```
...
4. Users can copy to their `/ctxai/data/usr/skills/` directory
