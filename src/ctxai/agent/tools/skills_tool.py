...
from ctxai.shared import projects, files, file_tree
from ctxai.shared import skills as skills_helper, runtime
...
class SkillsTool(Tool):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.required_scopes = [ToolScope.FILESYSTEM_READ]
