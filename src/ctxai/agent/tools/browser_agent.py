...
from ctxai.shared import files, defer, persist_chat, strings
from ctxai.shared.browser_use import browser_use  # type: ignore[attr-defined]
from ctxai.shared.print_style import PrintStyle
from ctxai.shared.playwright import ensure_playwright_binary
from ctxai.shared.secrets import get_secrets_manager
from ctxai.ext.python.message_loop_start._10_iteration_no import get_iter_no
    ...
    async def _initialize(self):
        ...
        self.browser_session = browser_use.BrowserSession(
            browser_profile=browser_use.BrowserProfile(
                ...
                downloads_path=files.get_abs_path(files.USER_DIR, "downloads"),
