...
from ctxai.core.agent import Agent, LoopData
from ctxai.utils import projects, skills
from ctxai.utils.extension import Extension
from ctxai.utils.mcp_handler import MCPConfig
from ctxai.utils.settings import get_settings


class SystemPrompt(Extension):
    async def execute(
        self, system_prompt: list[str] = None, loop_data: LoopData | None = None, **kwargs: Any
    ):
...
def get_tools_prompt(agent: Agent):
    prompt = agent.read_prompt("agent.system.ctxai.tools.md")
