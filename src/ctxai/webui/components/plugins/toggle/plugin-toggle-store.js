...
const model = {
  ...
  async open(plugin) {
    ...
    this.alwaysEnabled =
      typeof plugin === "object" ? !!plugin.always_enabled : false;
    this.perProjectConfig =
      typeof plugin === "object" ? !!plugin.per_project_config : true;
    this.perAgentConfig =
      typeof plugin === "object" ? !!plugin.per_agent_config : true;
    this.hasConfigScreen =
      typeof plugin === "object" ? !!plugin.has_config_screen : false;
