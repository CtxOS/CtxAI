...
Alpine.directive("move-to-start", (el, { expression }, { evaluateLater }) => {
...
Alpine.directive("move-to-end", (el, { expression }, { evaluateLater }) => {
  moveOnNextTick(el, expression, evaluateLater, (_el, selector) => {
    const parent = document.querySelector(selector);
    if (!parent) return;
...
Alpine.directive("move-before", (el, { expression }, { evaluateLater }) => {
  moveOnNextTick(el, expression, evaluateLater, (_el, selector) => {
...
Alpine.directive("move-after", (el, { expression }, { evaluateLater }) => {
  moveOnNextTick(el, expression, evaluateLater, (_el, selector) => {
    const ref = document.querySelector(selector);
    if (!ref || !ref.parentElement) return;
