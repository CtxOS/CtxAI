define("ace/ext/command_bar", [
  ...
  var r =
    ...
    g = 4,
    y = function (e, t) {
      return t.row > e.row ? e : t.row === e.row && t.column > e.column ? e : t;
    },
    b = {
      Ctrl: { mac: "^" },
      Option: { mac: "\u2325" },
    ...
    w = (function () {
      ...
      return (
        (e.prototype.registerCommand = function (e, t) {
          var n = Object.keys(this.commands).length < this.maxElementsOnTooltip;
          (!n &&
            !this.elements[v] &&
            this.$createCommand(
              v,
        ...
        (e.prototype.updatePosition = function () {
          ...
          if (this.isMoreOptionsShown()) {
            ...
            var d = this.moreOptions.getElement(),
              a = window.innerHeight;
            (c + d.offsetHeight > a && (c -= o.offsetHeight + d.offsetHeight),
        ...
        (e.prototype.destroy = function () {
          (this.tooltip &&
            this.moreOptions &&
            (this.detach(), this.tooltip.destroy(), this.moreOptions.destroy()),
            (this.eventListeners = {}),
            (this.commands = {}),
            (this.elements = {}),
        ...
        (e.prototype.$createCommand = function (e, t, n) {
          ...
          (n && t.iconCssClass
            ...
            u.buildDom(
              ["div", { class: [l, t.cssClass || ""].join(" "), ref: e }, o],
              r,
              this.elements,
            ),
            (this.commands[e] = t));
          var a = function (n) {
            (this.editor && this.editor.focus(),
              ...
              this.$shouldHideMoreOptions && this.$setMoreOptionsVisibility(!1),
              this.update(),
              n.preventDefault());
          }.bind(this);
        ...
        (e.prototype.$onMouseMove = function (e) {
          ...
          var t = this.editor.getCursorPosition(),
            n = this.editor.renderer.textToScreenCoordinates(t.row, t.column),
        ...
        (e.prototype.$updateOnHoverHandlers = function (e) {
          ...
          e
            ? (this.editor &&
              ...
              t.addEventListener("mouseleave", this.$scheduleTooltipForHide),
              n.addEventListener("mouseenter", this.$tooltipEnter),
              n.addEventListener("mouseleave", this.$scheduleTooltipForHide))
            : (this.editor &&
              ...
              t.removeEventListener("mouseleave", this.$scheduleTooltipForHide),
        ...
        (e.prototype.$hideTooltip = function () {
          this.$mouseInTooltip = !1;
          if (!this.isShown()) return;
          (this.moreOptions.hide(), this.tooltip.hide(), this._signal("hide"));
        }),
          ...
          if (typeof t.getValue == "function") {
            ...
            if (t.type === "text") n.textContent = i;
              ...
              ((n.ariaChecked = i),
                o
                  ? s(n, "ace_selected")
                  : ((n = n.querySelector("." + c)), s(n, "ace_checkmark")));
            }
          }
          r && n.disabled
