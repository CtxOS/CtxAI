(define(
      ...
      s = function () {
        ((this.$rules = {
          start: [
            ...
            },
            {
              todo: {
                ...
                push: [
                  ...
                  { include: "$self" },
                  { token: "variable.parameter.nasal", regex: /\w/ },
            ...
            { token: "storage.type.nasal", regex: /\b(?:return|var)\b/ },
            { token: "constant.language.nil.nasal", regex: /\bnil\b/ },
            {
              ...
              push: [
                ...
                { token: "constant.character.escape.nasal", regex: /\\'/ },
            ...
            { token: "punctuation.terminator.statement.nasal", regex: /\;/ },
            {
              token: [
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        i = e("./text").Mode,
        s = e("./nasal_highlight_rules").NasalHighlightRules,
