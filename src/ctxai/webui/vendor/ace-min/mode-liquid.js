(define(
      ...
      (r.inherits(f, i),
        function () {
          ((this.lineCommentStart = "//"),
            ...
            (this.createWorker = function (e) {
              var t = new a(["ace"], "ace/mode/json_worker", "JsonWorker");
              return (
                t.attachToDocument(e.getDocument()),
                t.on("annotate", function (t) {
                  e.setAnnotations(t.data);
  ...
  define(
    ...
    function (e, t, n) {
            ...
            return function (n) {
              var r = n.indexOf(e),
                i = [
                  ...
                  { type: "text", value: n.slice(2, r) },
                  {
                    type: "keyword.tag" + e + ".tag-name",
                    value: n.slice(r, r + t),
                  },
                  { type: "text", value: n.slice(r + t, n.indexOf("%}")) },
      ...
      (r.inherits(f, i), (t.LiquidHighlightRules = f));
    },
  ),
  define(
    "ace/mode/liquid",
    ...
    function (e, t, n) {
      var r = e("../lib/oop"),
        ...
        u = e("./json").Mode,
        a = e("./css").Mode,
        f = e("./liquid_highlight_rules").LiquidHighlightRules,
