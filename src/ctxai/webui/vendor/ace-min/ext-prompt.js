(define(
  ...
  define(
    ...
    function (e, t, n) {
      ...
      ((t.getModeForPath = i), (t.modes = r), (t.modesByName = a));
    },
  ),
  define(
    "ace/ext/prompt",
    ...
    function (e, t, n) {
      ...
      function d(e, t, n, r) {
        ...
        if (p) {
          var i = p;
          ((e = i.editor), i.close());
          if (i.name && i.name == n.name) return;
        }
        ...
        if (n.hasDescription) {
          var y = s.buildDom(["div", { class: "ace_prompt_text_container" }]);
          (s.buildDom(
      ...
      ((d.gotoLine = function (e, t) {
        ...
        d(e, ":" + n(e.selection.toJSON()), {
          ...
          onAccept: function (t) {
            var n = t.value,
              r = d.gotoLine._history;
            (r || (d.gotoLine._history = r = []),
              r.indexOf(n) != -1 && r.splice(r.indexOf(n), 1),
              r.unshift(n),
            ...
            (n
              ...
              .map(function (t) {
                function u() {
                  ...
                  if (!t) return;
                  if (t[0] == "c") {
                    var i = parseInt(t.slice(1)) || 0;
                    return e.session.doc.indexToPosition(i);
                  }
                  var o = s.row,
                    u = 0;
                  return (
                    /\d/.test(t) && ((o = parseInt(t) - 1), (t = n[r++])),
                    t == ":" &&
                      ((t = n[r++]), /\d/.test(t) && (u = parseInt(t) || 0)),
                    { row: o, column: u }
                  );
                }
        ...
        (d.commands = function (e, t) {
          ...
          var s = ["insertstring", "inserttext", "setIndentation", "paste"],
            u = i(s);
          ((u = u.map(function (e) {
