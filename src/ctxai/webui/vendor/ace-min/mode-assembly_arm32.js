(define(
  ...
  function (e, t, n) {
    ...
    ((s.metaData = {
      ...
      r.inherits(s, i),
      (t.AssemblyARM32HighlightRules = s));
  },
),
  define(
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        i = e("./text").Mode,
        s = e("./assembly_arm32_highlight_rules").AssemblyARM32HighlightRules,
