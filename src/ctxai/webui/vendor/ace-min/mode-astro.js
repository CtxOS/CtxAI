(define(
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        ...
        o = function () {
          function r(e) {
            for (var t in this.$rules[e + "jsxAttributes"])
              if (
                this.$rules[e + "jsxAttributes"][t].token ===
                "meta.tag.punctuation.tag-close.xml"
              ) {
                this.$rules[e + "jsxAttributes"][t].onMatch = function (
                  t,
                  n,
                  r,
                ) {
          ...
          var e = {
            ...
            next: function (e, t) {
              return (
                e !== "start" &&
                  (e.indexOf("attribute-equals") !== -1
                    ? (t.splice(0), t.unshift("tag_stuff"))
                    : t.unshift(e)),
                "inline-js-start"
              );
            },
          ...
          (this.$rules.start.unshift({
            ...
            this.embedRules(s, "inline-js-"));
          var n = [
            {
              regex: /}/,
              token: "paren.quasi.end",
              onMatch: function (e, t, n) {
                return n[0] === "inline-js-start"
                  ? (n.shift(),
                    (this.next = n.shift()),
                    this.next.indexOf("string") !== -1
                      ? "paren.quasi.end"
                      : "paren.rparen")
                  : ((this.next = n.shift() || "start"), this.token);
              },
            },
            { regex: /{/, token: "paren.lparen", push: "inline-js-start" },
          ];
          (this.$rules["inline-js-start"].unshift(n),
            this.$rules["inline-js-no_regex"].unshift(n),
            r.call(this, "javascript-"),
            r.call(this, "inline-js-"),
            this.normalizeRules());
        };
      (r.inherits(o, i), (t.AstroHighlightRules = o));
    },
  ),
  define(
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        i = e("./html").Mode,
        s = e("./astro_highlight_rules").AstroHighlightRules,
