(define(
        ...
        return (
          ...
          (e.prototype.addTabstops = function (e, t, n) {
            ...
            var s = this.index,
              o = [s + 1, 0],
              f = this.ranges,
              l = (this.snippetId = (this.snippetId || 0) + 1);
            (e.forEach(function (e, n) {
              var i = this.$openTabstops[n] || e;
              i.snippetId = l;
              for (var s = 0; s < e.length; s++) {
                var c = e[s],
                  h = u.fromPoints(c.start, c.end || c.start);
                (g(h.start, t),
                  g(h.end, t),
                  (h.original = c),
                  (h.tabstop = i),
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = (function () {
        ...
        return (
          (e.prototype.setScreenReaderContent = function (e) {
            !this.popup &&
                ...
                function () {
                  ...
                  if (n) {
                    ...
                    for (var i = 0; i < this._lines.length; i++)
                      r += "ace-inline-screenreader-line-".concat(i, " ");
            ...
            this._lines = e.split(/\r\n|\r|\n/);
            var t = this.createCodeBlock();
            this.screenReaderDiv.appendChild(t);
          }),
          (e.prototype.destroy = function () {
            this.screenReaderDiv.remove();
          }),
          (e.prototype.createCodeBlock = function () {
            var e = document.createElement("pre");
            e.setAttribute("id", "ace-inline-screenreader");
            for (var t = 0; t < this._lines.length; t++) {
              var n = document.createElement("code");
              n.setAttribute("id", "ace-inline-screenreader-line-".concat(t));
              var r = document.createTextNode(this._lines[t]);
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e("../snippets").snippetManager,
        i = e("./inline_screenreader").AceInlineScreenReader,
        s = (function () {
          function e() {
            this.editor = null;
          }
          return (
            (e.prototype.show = function (e, t, n) {
              ...
              if (!e || !t) return !1;
              this.inlineScreenReader || (this.inlineScreenReader = new i(e));
              var s = t.snippet
                ? r.getDisplayTextForSnippet(e, t.snippet)
                : t.value;
              return t.hideInlinePreview || !s || !s.startsWith(n)
                ? !1
                : ((this.editor = e),
                  this.inlineScreenReader.setScreenReaderContent(s),
                  (s = s.slice(n.length)),
                  s === "" ? e.removeGhostText() : e.setGhostText(s),
                  !0);
            }),
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e("../virtual_renderer").VirtualRenderer,
        ...
        h = l.isSafari ? "menu" : "listbox",
        p = l.isSafari ? "menuitem" : "option",
        d = l.isSafari ? "aria-current" : "aria-selected",
        v = function (e) {
          var t = new r(e);
          t.$maxLines = 4;
          var n = new i(t);
        ...
        m = (function () {
          function e(e) {
            ...
            (e && e.appendChild(t),
              ...
              n.renderer.$textLayer.element.setAttribute("role", h),
              ...
              n.renderer.$textLayer.element.setAttribute(
                "aria-label",
                f("autocomplete.popup.aria-label", "Autocomplete suggestions"),
              ),
            ...
            ((n.focus = r),
              ...
              n.on("mousedown", function (e) {
                ...
                (n.selection.moveToPosition(t),
                  (m.start.row = m.end.row = t.row),
                  e.stop());
              }));
            var i,
              l = new s(-1, 0, -1, Infinity),
              m = new s(-1, 0, -1, Infinity);
            ((m.id = n.session.addMarker(m, "ace_active-line", "fullLine")),
              ...
              n.on("mousemove", function (e) {
                ...
                l.start.row != t && (l.id || n.setRow(t), y(t));
              }),
              n.renderer.on("beforeRender", function () {
                if (i && l.start.row != -1) {
                  i.$pos = null;
                  var e = i.getDocumentPosition().row;
                  (l.id || n.setRow(e), y(e, !0));
                }
              }),
              n.renderer.on("afterRender", function () {
                var e = n.renderer.$textLayer;
                for (
                  var t = e.config.firstRow, r = e.config.lastRow;
                  t <= r;
                  t++
                ) {
                  var i = e.element.childNodes[t - e.config.firstRow];
                  (i.setAttribute("role", p),
                    i.setAttribute(
                      "aria-roledescription",
                      f("autocomplete.popup.item.aria-roledescription", "item"),
                    ),
                  ...
                  if (s) {
                    var o = ""
                      .concat(s.caption || s.value)
                      .concat(s.meta ? ", ".concat(s.meta) : "");
                    i.setAttribute("aria-label", o);
                  }
                  var u = i.querySelectorAll(".ace_completion-highlight");
                  u.forEach(function (e) {
              ...
              n.renderer.on("afterRender", function () {
                ...
                (r !== n.selectedNode &&
                  n.selectedNode &&
                  (a.removeCssClass(n.selectedNode, "ace_selected"),
                  n.selectedNode.removeAttribute(d),
                  n.selectedNode.removeAttribute("id")),
                  i.removeAttribute("aria-activedescendant"),
                  (n.selectedNode = r));
                if (r) {
                  var s = c(e);
                  (a.addCssClass(r, "ace_selected"),
                    (r.id = s),
                    t.element.setAttribute("aria-activedescendant", s),
                    i.setAttribute("aria-activedescendant", s),
            ...
            ((n.getHoveredRow = function () {
              ...
              o.addListener(n.container, "mouseout", function () {
                ((n.isMouseOver = !1), g());
              }),
              n.on("hide", g),
            ...
            var b = n.session.bgTokenizer;
            return (
              (b.$tokenizeRow = function (e) {
                function s(e, n) {
                  e &&
                ...
                return (
                  ...
                  r.push({ type: "completion-spacer", value: " " }),
              ...
              (n.tryShow = function (e, t, r, s) {
                ...
                var o = this.container,
                  u = this.renderer.scrollBar.width || 10,
                  a = window.innerHeight - u,
                  f = window.innerWidth - u,
                  l = this.renderer,
                  c = l.$maxLines * t * 1.4,
                  h = { top: 0, bottom: 0, left: 0 },
                  p = a - e.top - 3 * this.$borderSize - t,
                  d = e.top - 3 * this.$borderSize;
                (r || (d <= p || p >= c ? (r = "bottom") : (r = "top")),
                  r === "top"
                    ...
                    : r === "bottom" &&
                      ...
                      (h.bottom = h.top + c)));
                var v = h.top >= 0 && h.bottom <= a;
                if (!s && !v) return !1;
                (v
                  ? (l.$maxPixelHeight = null)
                  : r === "top"
                    ? (l.$maxPixelHeight = d)
                    : (l.$maxPixelHeight = p),
                  r === "top"
                    ? ((o.style.top = ""),
                      (o.style.bottom = a + u - h.bottom + "px"),
                      (n.isTopdown = !1))
                ...
                var m = e.left;
                return (
                  m + o.offsetWidth > f && (m = f - o.offsetWidth),
                  (o.style.left = m + "px"),
                  (o.style.right = ""),
                  n.isOpen ||
                    ((n.isOpen = !0), this._signal("show"), (i = null)),
                  (n.anchorPos = e),
                  (n.anchor = r),
                  !0
                );
              ...
              (n.show = function (e, t, n) {
                this.tryShow(e, t, n ? "bottom" : undefined, !0);
              }),
              (n.goTo = function (e) {
                var t = this.getRow(),
    ...
    function (e, t, n) {
      ...
      ((t.retrievePrecedingIdentifier = function (e, t, n) {
        ...
        (t.triggerAutocomplete = function (e, t) {
          var t = t == null ? e.session.getPrecedingCharacter() : t;
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e("./keyboard/hash_handler").HashHandler,
        ...
        o = e("./autocomplete/popup").getAriaId,
        ...
        c = e("./config"),
        h = e("./lib/event"),
        p = e("./lib/scroll").preventParentScroll,
        d = function (e, t) {
        ...
        v = (function () {
          function e() {
            ((this.autoInsert = !1),
              ...
              (this.popupTimer = a.delayedCall(
                this.$updatePopupPosition.bind(this),
                50,
              )),
              (this.stickySelectionTimer = a.delayedCall(
                function () {
                  this.stickySelection = !0;
                }.bind(this),
                this.stickySelectionDelay,
              )),
              (this.$firstOpenTimer = a.delayedCall(
                function () {
                  var t =
                  ...
                  if (
                    ...
                    return;
                  ((this.completions = new g(e.completionsForLoading)),
                    this.openPopup(this.editor, t.prefix, !1),
                    this.popup.renderer.setStyle("ace_loading", !0));
                }.bind(this),
                this.stickySelectionDelay,
              )));
          }
          return (
            Object.defineProperty(e, "completionsForLoading", {
              get: function () {
                return [
                  {
                    caption: c.nls("autocomplete.loading", "Loading..."),
                    value: "",
                  },
                ];
              },
            ...
            (e.prototype.$seen = function (e) {
              !this.hasSeen.has(e) &&
                ...
                e.completer &&
                e.completer.onSeen &&
                typeof e.completer.onSeen == "function" &&
                (e.completer.onSeen(this.editor, e), this.hasSeen.add(e));
            }),
            ...
            (e.prototype.$updateGhostText = function (e) {
              var t = this.base.row,
                n = this.base.column,
                r = this.editor.getCursorPosition().column,
                i = this.editor.session.getLine(t).slice(n, r);
              this.inlineRenderer.show(this.editor, e, i)
                ? this.$seen(e)
                : this.inlineRenderer.hide();
            }),
            (e.prototype.$onPopupRender = function () {
              var e = this.inlineRenderer && this.inlineEnabled;
              if (
                this.completions &&
                ...
                for (
                  var t = this.popup.getFirstVisibleRow();
                  t <= this.popup.getLastVisibleRow();
                  t++
                ) {
                  var n = this.popup.getData(t);
                  n && (!e || n.hideInlinePreview) && this.$seen(n);
                }
            }),
            (e.prototype.$onPopupShow = function (e) {
              (this.$onPopupChange(e),
                (this.stickySelection = !1),
                this.stickySelectionDelay >= 0 &&
                  this.stickySelectionTimer.schedule(
                    this.stickySelectionDelay,
                  ));
            }),
            ...
            (e.prototype.$updatePopupPosition = function () {
              var e = this.editor,
                ...
                r = t.$cursorLayer.getPixelPosition(this.base, !0);
              r.left -= this.popup.getTextLeftOffset();
              var i = e.container.getBoundingClientRect();
              ((r.top += i.top - t.layerConfig.offset),
                (r.left += i.left - e.renderer.scrollLeft),
                (r.left += t.gutterWidth));
              var s = { top: r.top, left: r.left };
              t.$ghostText &&
                t.$ghostTextWidget &&
                this.base.row === t.$ghostText.position.row &&
                (s.top += t.$ghostTextWidget.el.offsetHeight);
              var o = e.container.getBoundingClientRect().bottom - n,
                u = o < s.top ? { top: o, left: s.left } : s;
              if (this.popup.tryShow(u, n, "bottom")) return;
              if (this.popup.tryShow(r, n, "top")) return;
              this.popup.show(r, n);
            }),
            (e.prototype.openPopup = function (e, t, n) {
              ...
              (this.popup.setData(
                ...
                this.editor.textInput.setAriaOptions &&
                  this.editor.textInput.setAriaOptions({
                    activeDescendant: o(this.popup.getRow()),
                    inline: this.inlineEnabled,
                  }),
                e.keyBinding.addKeyboardHandler(this.keyboardHandler));
              var s;
              this.stickySelection && (s = this.popup.data.indexOf(i));
              if (!s || s === -1) s = 0;
              (this.popup.setRow(this.autoSelect ? s : -1),
                s === r &&
                  i !== this.completions.filtered[s] &&
                  this.$onPopupChange());
              var u = this.inlineRenderer && this.inlineEnabled;
              if (s === r && u) {
                var a = this.popup.getData(this.popup.getRow());
                this.$updateGhostText(a);
              }
              (n ||
            ...
            (e.prototype.mouseOutListener = function (e) {
            ...
            (e.prototype.insertMatch = function (e, t) {
              ...
              var n = this.completions,
                r = this.getCompletionProvider().insertMatch(
                  this.editor,
                  e,
                  n.filterText,
                  t,
                );
              return (this.completions == n && this.detach(), r);
            }),
            ...
            (e.prototype.getCompletionProvider = function (e) {
              return (
                this.completionProvider || (this.completionProvider = new m(e)),
                this.completionProvider
              );
            }),
            ...
            (e.prototype.updateCompletions = function (t, n) {
              if (t && this.base && this.completions) {
                var r = this.editor.getCursorPosition(),
                ...
                if (
                  ...
                  return this.detach();
                this.openPopup(this.editor, i, t);
                return;
              }
              if (n && n.matches) {
                var r = this.editor.getSelectionRange().start;
                return (
                  ...
                  (this.completions = new g(n.matches)),
                  (this.getCompletionProvider().completions = this.completions),
                  this.openPopup(this.editor, "", t)
                );
              }
              var s = this.editor.getSession(),
                r = this.editor.getCursorPosition(),
                i = u.getCompletionPrefix(this.editor);
              ((this.base = s.doc.createAnchor(r.row, r.column - i.length)),
                (this.base.$insertRight = !0));
              var o = {
              ...
              (this.getCompletionProvider({
                ...
                function (n, r, i) {
                  var s = r.filtered,
                    o = u.getCompletionPrefix(this.editor);
                  this.$firstOpenTimer.cancel();
                  if (i) {
                    if (!s.length) {
                      var a = !this.autoShown && this.emptyMessage;
                      typeof a == "function" && (a = this.emptyMessage(o));
                      if (a) {
                        var f = [{ caption: a, value: "" }];
                        ((this.completions = new g(f)),
                          this.openPopup(this.editor, o, t),
                          this.popup.renderer.setStyle("ace_loading", !1),
                          this.popup.renderer.setStyle(
                            "ace_empty-message",
                            !0,
                          ));
                        return;
                    ...
                    if (s.length == 1 && s[0].value == o && !s[0].snippet)
                      return this.detach();
                    if (this.autoInsert && !this.autoShown && s.length == 1)
                      return this.insertMatch(s[0]);
                  }
                  ((this.completions =
                    !i && this.showLoadingState
                      ? new g(e.completionsForLoading.concat(s), r.filterText)
                      : r),
                    this.openPopup(this.editor, o, t),
                    this.popup.renderer.setStyle("ace_empty-message", !1),
                    this.popup.renderer.setStyle("ace_loading", !i));
                }.bind(this),
              ),
            ...
            (e.prototype.updateDocTooltip = function () {
              var e = this.popup,
                t = this.completions && this.completions.filtered,
                n = t && (t[e.getHoveredRow()] || t[e.getRow()]),
                r = null;
              if (!n || !this.editor || !this.popup.isOpen)
                return this.hideDocTooltip();
              var i = this.editor.completers.length;
              for (var s = 0; s < i; s++) {
                var o = this.editor.completers[s];
                if (o.getDocTooltip && n.completerId === o.id) {
                  r = o.getDocTooltip(n);
                  break;
                }
              }
            ...
            (e.prototype.showDocTooltip = function (e) {
              this.tooltipNode ||
                ((this.tooltipNode = f.createElement("div")),
                ...
                this.tooltipNode.addEventListener("wheel", p));
              ...
              var r = this.popup,
                ...
                s = 400,
                o = 300,
                u = r.renderer.scrollBar.width || 10,
                a = i.left,
                l = window.innerWidth - i.right - u,
                c = r.isTopdown ? i.top : window.innerHeight - u - i.bottom,
                h = [
                  Math.min(l / s, 1),
                  Math.min(a / s, 1),
                  Math.min((c / o) * 0.9),
                ],
                d = Math.max.apply(Math, h),
                v = n.style;
              ((v.display = "block"),
                d == h[0]
                  ? ((v.left = i.right + 1 + "px"),
                    ...
                    (v.bottom = ""),
                    (v.maxHeight =
                      Math.min(window.innerHeight - u - i.top, o) + "px"))
                  : d == h[1]
                    ? ((v.right = window.innerWidth - i.left + "px"),
                      (v.left = ""),
                      (v.maxWidth = s * d + "px"),
                      (v.top = i.top + "px"),
                      (v.bottom = ""),
                      (v.maxHeight =
                        Math.min(window.innerHeight - u - i.top, o) + "px"))
                    : d == h[2] &&
                      ((v.left = window.innerWidth - i.left + "px"),
                      (v.maxWidth = Math.min(s, window.innerWidth) + "px"),
                      r.isTopdown
                        ? ((v.top = i.bottom + "px"),
                          (v.left = i.left + "px"),
                          (v.right = ""),
                          (v.bottom = ""),
                          (v.maxHeight =
                            Math.min(window.innerHeight - u - i.bottom, o) +
                            "px"))
                        : ((v.top =
                            r.container.offsetTop - n.offsetHeight + "px"),
                          (v.left = i.left + "px"),
                          (v.right = ""),
                          (v.bottom = ""),
                          (v.maxHeight =
                            Math.min(r.container.offsetTop, o) + "px"))));
            }),
            ...
            (e.for = function (t) {
              return t.completer instanceof e
                ? t.completer
                : (t.completer && (t.completer.destroy(), (t.completer = null)),
                  c.get("sharedPopups")
                    ? (e.$sharedInstance || (e.$sharedInstance = new e()),
                      (t.completer = e.$sharedInstance))
                    : ((t.completer = new e()), t.once("destroy", d)),
                  t.completer);
            }),
            e
          );
      ...
      ((v.prototype.commands = {
        ...
        Backspace: function (e) {
          e.execCommand("backspace");
          var t = u.getCompletionPrefix(e);
          !t && e.completer && e.completer.detach();
        },
        PageUp: function (e) {
          ...
          return (
            ...
            (e.prototype.insertMatch = function (e, t, n) {
              ...
              if (t.completer && t.completer.insertMatch)
                ...
                var r = this.completions.filterText.length,
                  i = 0;
                t.range &&
                  t.range.start.row === t.range.end.row &&
                  ((r -= this.initialPosition.prefix.length),
                  (r += this.initialPosition.pos.column - t.range.start.column),
                  (i += t.range.end.column - this.initialPosition.pos.column));
                if (r || i) {
                  var s;
                  e.selection.getAllRanges
                    ? (s = e.selection.getAllRanges())
                    : (s = [e.getSelectionRange()]);
                ...
                (t.snippet
                  ? l.insertSnippet(e, t.snippet)
                  : this.$insertString(e, t),
                  t.completer &&
                    t.completer.onInsert &&
                    typeof t.completer.onInsert == "function" &&
                    t.completer.onInsert(e, t),
                  t.command &&
                    t.command === "startAutocomplete" &&
            ...
            (e.prototype.$insertString = function (e, t) {
              var n = t.value || t;
              e.execCommand("insertstring", n);
            }),
            (e.prototype.gatherCompletions = function (e, t) {
              var n = e.getSession(),
                r = e.getCursorPosition(),
                i = u.getCompletionPrefix(e),
                s = [];
              this.completers = e.completers;
              var o = e.completers.length;
              return (
                    ...
                    (a.hideInlinePreview &&
                      (r = r.map(function (e) {
                        return Object.assign(e, {
                          hideInlinePreview: a.hideInlinePreview,
                        });
                      })),
                      !n && r && (s = s.concat(r)),
                      t(null, {
                        prefix: u.getCompletionPrefix(e),
                        matches: s,
                        finished: --o === 0,
                      }));
                  });
            ...
            (e.prototype.provideCompletions = function (e, t, n) {
              ...
              (this.gatherCompletions(
                ...
                function (e, t) {
                  ...
                  e && (n(e, [], !0), this.detach());
                  var o = t.prefix;
                  if (o.indexOf(t.prefix) !== 0) return;
                  if (i) {
                    s = t;
                    return;
                  }
          ...
          return (
            ...
            (e.prototype.filterCompletions = function (e, t) {
              ...
              e: for (var s = 0, o; (o = e[s]); s++) {
                if (o.skipFilter) {
                  ((o.$score = o.score), n.push(o));
                  continue;
                }
                var u =
                  (!this.ignoreCaption && o.caption) || o.value || o.snippet;
                if (!u) continue;
                var a = -1,
                  f = 0,
                  l = 0,
  ...
  define(
    ...
    function (e, t, n) {
      var r =
        ...
        a = e("../lib/oop"),
        f = e("../lib/useragent"),
        l = "command_bar_tooltip_button",
        c = "command_bar_button_value",
        h = "command_bar_button_caption",
        p = "command_bar_keybinding",
        d = "command_bar_tooltip",
        v = "MoreOptionsButton",
        m = 100,
        g = 4,
        y = function (e, t) {
        ...
        w = (function () {
          function e(e, t) {
            ...
            ((t = t || {}),
              (this.parentNode = e),
              (this.tooltip = new i(this.parentNode)),
              (this.moreOptions = new i(this.parentNode)),
              (this.maxElementsOnTooltip = t.maxElementsOnTooltip || g),
              ...
              (this.moreOptionsEl = u.buildDom(
                ["div", { class: d + " tooltip_more_options" }],
                this.moreOptions.getElement(),
              )),
              (this.$showTooltipTimer = o.delayedCall(
                this.$showTooltip.bind(this),
                t.showDelay || m,
              )),
              (this.$hideTooltipTimer = o.delayedCall(
            ...
            try {
              for (
                var a = r(["mousedown", "mouseup", "click"]), f = a.next();
                !f.done;
                f = a.next()
              ) {
                var l = f.value;
                (this.tooltip
                  .getElement()
                  .addEventListener(l, this.$preventMouseEvent),
                  this.moreOptions
                    .getElement()
                    .addEventListener(l, this.$preventMouseEvent));
              }
          ...
          return (
            ...
            (e.prototype.attach = function (e) {
              if (!e || (this.isShown() && this.editor === e)) return;
              (this.detach(),
                (this.editor = e),
            ...
            (e.prototype.updatePosition = function () {
              ...
              if (!t.length) return;
              var n = y(t[0].start, t[0].end);
              for (var r = 0, i; (i = t[r]); r++) n = y(n, y(i.start, i.end));
              var s = e.$cursorLayer.getPixelPosition(n, !0),
                o = this.tooltip.getElement(),
                u = window.innerWidth,
                a = window.innerHeight,
                f = this.editor.container.getBoundingClientRect();
              ((s.top += f.top - e.layerConfig.offset),
                (s.left += f.left + e.gutterWidth - e.scrollLeft));
              var l =
                s.top >= f.top &&
                s.top <= f.bottom &&
                s.left >= f.left + e.gutterWidth &&
                s.left <= f.right;
              if (!l && this.isShown()) {
                this.$hideTooltip();
                return;
              }
              if (l && !this.isShown() && this.getAlwaysShow()) {
                this.$showTooltip();
                return;
              }
              var c = s.top - o.offsetHeight,
                h = Math.min(u - o.offsetWidth, s.left),
                p =
                  c >= 0 &&
                  c + o.offsetHeight <= a &&
                  h >= 0 &&
              ...
              this.tooltip.setPosition(h, c);
              if (this.isMoreOptionsShown()) {
                ((c += o.offsetHeight),
                  (h = this.elements[v].getBoundingClientRect().left));
                var d = this.moreOptions.getElement(),
                  a = window.innerHeight;
                (c + d.offsetHeight > a &&
                  (c -= o.offsetHeight + d.offsetHeight),
                  h + d.offsetWidth > u && (h = u - d.offsetWidth),
                  this.moreOptions.setPosition(h, c));
              }
            }),
            ...
            (e.prototype.$createCommand = function (e, t, n) {
              var r = n ? this.tooltipEl : this.moreOptionsEl,
                i = [],
                s = t.bindKey;
              s &&
                (typeof s == "object" && (s = f.isMac ? s.mac : s.win),
                (s = s.split("|")[0]),
                (i = s.split("-")),
                (i = i.map(function (e) {
                  if (b[e]) {
                    if (typeof b[e] == "string") return b[e];
                    if (f.isMac && b[e].mac) return b[e].mac;
                  }
                  return e;
                })));
              var o;
              ...
              ((this.eventListeners[e] = a),
                this.elements[e].addEventListener("click", a.bind(this)),
                this.$updateElement(e));
            }),
            (e.prototype.$setMoreOptionsVisibility = function (e) {
              e
                ? (this.moreOptions.setTheme(this.editor.renderer.theme),
                  this.moreOptions.setClassName(d + "_wrapper"),
            ...
            (e.prototype.$onMouseMove = function (e) {
              if (this.$mouseInTooltip) return;
              var t = this.editor.getCursorPosition(),
                n = this.editor.renderer.textToScreenCoordinates(
                  t.row,
                  t.column,
                ),
                r = this.editor.renderer.lineHeight,
                i = e.clientY >= n.pageY && e.clientY < n.pageY + r;
              i
                ? (!this.isShown() &&
            ...
            (e.prototype.$updateOnHoverHandlers = function (e) {
              ...
              e
                ? (this.editor &&
                  ...
                  n.addEventListener("mouseenter", this.$tooltipEnter),
                  n.addEventListener(
                    "mouseleave",
                    this.$scheduleTooltipForHide,
                  ))
                : (this.editor &&
                  ...
                  n.removeEventListener("mouseenter", this.$tooltipEnter),
            ...
            (e.prototype.$showTooltip = function () {
              ...
              (this.tooltip.setTheme(this.editor.renderer.theme),
                this.tooltip.setClassName(d + "_wrapper"),
                this.tooltip.show(),
                this.update(),
                this.updatePosition(),
                this._signal("show"));
            ...
            (e.prototype.$updateElement = function (e) {
              ...
              var n = this.elements[e],
                r = t.enabled;
              typeof r == "function" && (r = r(this.editor));
              if (typeof t.getValue == "function") {
                var i = t.getValue(this.editor);
                if (t.type === "text") n.textContent = i;
                else if (t.type === "checkbox") {
                  var s = i ? u.addCssClass : u.removeCssClass,
                    o = n.parentElement === this.tooltipEl;
                  ((n.ariaChecked = i),
                    o
                      ? s(n, "ace_selected")
                      : ((n = n.querySelector("." + c)),
              ...
              r && n.disabled
                ? (u.removeCssClass(n, "ace_disabled"),
                  (n.ariaDisabled = n.disabled = !1),
                  n.removeAttribute("disabled"))
                : !r &&
                  !n.disabled &&
                  (u.addCssClass(n, "ace_disabled"),
                  (n.ariaDisabled = n.disabled = !0),
                  n.setAttribute("disabled", ""));
            }),
            e
          );
        })();
      (a.implement(w.prototype, s),
        u.importCssString(
          "\n.ace_tooltip."
            .concat(d, "_wrapper {\n    padding: 0;\n}\n\n.ace_tooltip .")
            .concat(
        ...
        (t.CommandBarTooltip = w),
        (t.TOOLTIP_CLASS_NAME = d),
        (t.BUTTON_CLASS_NAME = l));
    },
  ),
  define(
    "ace/marker_group",
    ...
    function (e, t, n) {
      ...
      var r = (function () {
        function e(e, t) {
          (t && (this.markerType = t.markerType),
            (this.markers = []),
            (this.session = e),
            e.addDynamicMarker(this));
        }
        return (
          (e.prototype.getMarkerAtPosition = function (e) {
            return this.markers.find(function (t) {
              return t.range.contains(e.row, e.column);
            });
          }),
          (e.prototype.markersComparator = function (e, t) {
            return e.range.start.row - t.range.start.row;
          }),
          (e.prototype.setMarkers = function (e) {
            ((this.markers = e
              .sort(this.markersComparator)
          ...
          (e.prototype.update = function (e, t, n, r) {
            ...
            for (var f = 0; f < this.markers.length; f++) {
              var l = this.markers[f];
              if (l.range.end.row < i) continue;
              if (l.range.start.row > s) continue;
              l.range.start.row === a
                ? u++
                : ((a = l.range.start.row), (u = 0));
              if (u > 200) continue;
              var c = l.range.clipRows(i, s);
              if (c.start.row === c.end.row && c.start.column === c.end.column)
                continue;
              var h = c.toScreenRange(n);
              if (h.isEmpty()) {
                ((o = n.getNextFoldLine(c.end.row, o)),
                  o && o.end.row > c.end.row && (i = o.end.row));
                continue;
              }
              this.markerType === "fullLine"
                ? t.drawFullLineMarker(e, h, l.className, r)
                : h.isMultiLine()
                  ? this.markerType === "line"
                    ? t.drawMultiLineMarker(e, h, l.className, r)
                    : t.drawTextMarker(e, h, l.className, r)
                  : t.drawSingleLineMarker(e, h, l.className + " ace_br15", r);
            }
          }),
          e
        );
      })();
      ((r.prototype.MAX_MARKERS = 1e4), (t.MarkerGroup = r));
    },
  ),
  define(
    ...
    function (e, t, n) {
      ...
      var d = {
        ...
        m = function (e) {
          ...
          if (!e) return;
          (r.files || (r.files = {}),
            g(e.$id, e.snippetFileId),
            e.modes && e.modes.forEach(m));
        },
        g = function (e, t) {
        ...
        y = function (e) {
          ...
          else if (e.command.name === "insertstring" && !n) {
            b = e;
            var r = e.editor.$liveAutocompletionDelay;
            r ? w.delay(r) : E(e);
          }
        },
        b,
        ...
        E = function (e) {
          var t = e.editor,
            n = u.getCompletionPrefix(t),
            r = e.args,
            s = u.triggerAutocomplete(t, r);
          if ((n && n.length >= t.$liveAutocompletionThreshold) || s) {
            var o = i.for(t);
            ((o.autoShown = !0), o.showPopup(t));
          }
        },
        S = e("../editor").Editor;
      (e("../config").defineOptions(S.prototype, "editor", {
        enableBasicAutocompletion: {
          set: function (e) {
            e
              ? (i.for(this),
                this.completers || (this.completers = Array.isArray(e) ? e : p),
          ...
          set: function (e) {
            e
              ? (this.completers ||
                ...
                this.commands.on("afterExec", y))
              : this.commands.off("afterExec", y);
          },
          value: !1,
        },
        ...
        enableSnippets: {
          set: function (e) {
            e
              ? (this.commands.addCommand(d),
                this.on("changeMode", v),
                v(null, this))
              : (this.commands.removeCommand(d), this.off("changeMode", v));
          },
          value: !1,
        },
      }),
  ...
  define(
    ...
    function (e, t, n) {
      "use strict";
      var r = e("../keyboard/hash_handler").HashHandler,
        i = e("../autocomplete/inline").AceInline,
        s = e("../autocomplete").FilteredList,
        o = e("../autocomplete").CompletionProvider,
        u = e("../editor").Editor,
        a = e("../autocomplete/util"),
        f = e("../lib/dom"),
        l = e("../lib/lang"),
        c = e("./command_bar").CommandBarTooltip,
        h = e("./command_bar").BUTTON_CLASS_NAME,
        p = e("./language_tools").snippetCompleter,
        d = e("./language_tools").textCompleter,
        v = e("./language_tools").keyWordCompleter,
        m = function (e, t) {
          t.completer && t.completer.destroy();
        },
        g = (function () {
          function e(e) {
            ((this.editor = e),
              (this.keyboardHandler = new r(this.commands)),
              (this.$index = -1),
              (this.blurListener = this.blurListener.bind(this)),
              (this.changeListener = this.changeListener.bind(this)),
              (this.changeTimer = l.delayedCall(
                function () {
          ...
          return (
            (e.prototype.getInlineRenderer = function () {
              return (
                this.inlineRenderer || (this.inlineRenderer = new i()),
                this.inlineRenderer
              );
            }),
            ...
            (e.prototype.$open = function () {
              (this.editor.textInput.setAriaOptions &&
                ...
                this.$index === -1 ? this.setIndex(0) : this.$showCompletion(),
                this.changeTimer.cancel());
            }),
            ...
            (e.prototype.setIndex = function (e) {
              ...
              t !== this.$index && ((this.$index = t), this.$showCompletion());
            }),
            (e.prototype.getCompletionProvider = function (e) {
              return (
                this.completionProvider || (this.completionProvider = new o(e)),
                this.completionProvider
              );
            }),
            ...
            (e.prototype.updateCompletions = function (e) {
              ...
              if (e && e.matches) {
                ...
                return (
                  ...
                  (this.base.$insertRight = !0),
                  (this.completions = new s(e.matches)),
                  this.$open(this.editor, "")
                );
              }
              this.base && this.completions && (t = this.$updatePrefix());
              var r = this.editor.getSession(),
                n = this.editor.getCursorPosition(),
                t = a.getCompletionPrefix(this.editor);
              ((this.base = r.doc.createAnchor(n.row, n.column - t.length)),
                (this.base.$insertRight = !0));
              var e = { exactMatch: !0, ignoreCaption: !0 };
              this.getCompletionProvider({
                prefix: t,
                base: this.base,
                pos: n,
                ...
                function (e, t, n) {
                  ...
                  if (n) {
                    if (!r.length) return this.detach();
                    if (r.length == 1 && r[0].value == i && !r[0].snippet)
                      return this.detach();
                  }
                  ((this.completions = t), this.$open(this.editor, i));
                }.bind(this),
              );
            }),
            (e.prototype.detach = function () {
      ...
      ((g.prototype.commands = {
        ...
        (g.for = function (e) {
          return e.completer instanceof g
            ? e.completer
      ...
      (e("../config").defineOptions(u.prototype, "editor", {
        enableInlineAutocompletion: {
          set: function (e) {
            e
              ? (this.completers ||
                  (this.completers = Array.isArray(e) ? e : y),
        ...
        (g.createInlineTooltip = function (e) {
          var t = new c(e);
          return (
            t.registerCommand(
              "Previous",
              Object.assign({}, g.prototype.commands.Previous, {
                enabled: !0,
                type: "button",
            ...
            t.registerCommand(
              "Next",
              Object.assign({}, g.prototype.commands.Next, {
                enabled: !0,
                type: "button",
            ...
            t.registerCommand(
              "Accept",
              Object.assign({}, g.prototype.commands.Accept, {
                enabled: function (e) {
