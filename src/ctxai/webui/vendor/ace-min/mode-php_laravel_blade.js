          ...
          ((this.getFoldWidgetRangeBase = this.getFoldWidgetRange),
            ...
            (this.getFoldWidgetRange = function (e, t, n) {
              var r = e.doc.getLine(n),
                i = this.foldingStartMarkerPhp.exec(r);
              if (i) return this.phpBlock(e, n, i.index + 2);
              var i = this.foldingStopMarkerPhp.exec(r);
              return i
                ? this.phpBlock(e, n, i.index + 2)
                : this.getFoldWidgetRangeBase(e, t, n);
            }),
            (this.getFoldWidget = function (e, t, n) {
              var r = e.getLine(n),
                i = this.foldingStartMarkerPhp.test(r),
                s = this.foldingStopMarkerPhp.test(r);
              if (i && !s) {
                var o = this.foldingStartMarkerPhp.exec(r),
                  u = o && o[1].toLowerCase();
                if (u) {
                  var a = e.getTokenAt(n, o.index + 2).type;
                  if (a == "keyword") return "start";
                }
              }
              if (s && t === "markbeginend") {
                var o = this.foldingStopMarkerPhp.exec(r),
                  u = o && o[1].toLowerCase();
                if (u) {
                  var a = e.getTokenAt(n, o.index + 2).type;
                  if (a == "keyword") return "end";
                }
              }
              return this.getFoldWidgetBase(e, t, n);
            }),
            (this.phpBlock = function (e, t, n, r) {
              var i = new o(e, t, n),
                u = i.getCurrentToken();
              ...
              while ((u = i.step())) {
                ...
                var p = l * this.indentKeywords[u.value];
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        ...
        l = e("./folding/php").FoldMode,
        c = e("../unicode"),
        h = e("./folding/mixed").FoldMode,
        p = e("./folding/html").FoldMode,
      ...
      var b = function (e) {
        ...
        (v.call(this),
          (this.HighlightRules = s),
          this.createModeDelegates({ "js-": m, "css-": g, "php-": y }),
          (this.foldingRules = new h(new p(), {
            "js-": new d(),
            "css-": new d(),
            "php-": new l(),
      ...
      (r.inherits(b, v),
        function () {
          ((this.createWorker = function (e) {
            var t = new a(["ace"], "ace/mode/php_worker", "PhpWorker");
            return (
              t.attachToDocument(e.getDocument()),
