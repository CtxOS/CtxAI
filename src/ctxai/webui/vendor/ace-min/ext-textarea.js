define("ace/ext/textarea", [
  ...
  function a(e, t) {
    ...
    var n = e.parentNode,
      ...
      s = function () {
        ...
        var n = o(e, i, "width") || e.clientWidth + "px",
          r = o(e, i, "height") || e.clientHeight + "px";
        ((t += "height:" + r + ";width:" + n + ";"),
  ...
  ((t.transformTextarea = function (e, n) {
    var o = e.autofocus || document.activeElement == e,
      c,
      h = a(e, function () {
        return c.getValue();
      });
    ((e.style.display = "none"), (h.style.background = "white"));
    ...
    var g = s.edit(p);
    ((c = g.getSession()),
      c.setValue(e.value || e.innerHTML),
      o && g.focus(),
      h.appendChild(d),
      f(g, p, v, s, n),
      l(v, d, g));
    ...
    return (
      ...
      r.addListener(d, "mousedown", function (e) {
        ...
        r.capture(
          d,
          function (e) {
            ((h.style.width = e.clientX - t.left + n + "px"),
              (h.style.height = e.clientY - t.top + i + "px"),
              g.resize());
          },
          function () {},
        );
