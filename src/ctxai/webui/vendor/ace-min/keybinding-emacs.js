(define(
    ...
    var r =
      ...
      a = (function (e) {
        ...
        return (
          ...
          (t.prototype.displayOccurContent = function (e, t) {
          ...
          (t.prototype.displayOriginalContent = function (e) {
            (e.setSession(this.$originalSession),
              (this.$originalSession.$useEmacsStyleLineStart =
                this.$useEmacsStyleLineStart));
          }),
          (t.prototype.originalToOccurPosition = function (e, t) {
          ...
          (t.prototype.occurToOriginalPosition = function (e, t) {
            var n = e.$occurMatchingLines;
            return !n || !n[t.row]
              ? t
              : { row: n[t.row].row, column: t.column };
          }),
          (t.prototype.matchingLines = function (e, t) {
            t = i.mixin({}, t);
      ...
      var r =
        ...
        p = (function (e) {
          function t() {
            ...
            return (
              (t.$options = { wrap: !1, skipCurrent: !1 }),
              (t.$keyboardHandler = new a(t)),
              t
            );
          }
          return (
            ...
            (t.prototype.selectionFix = function (e) {
              e.selection.isEmpty() &&
                !e.session.$emacsMark &&
                e.clearSelection();
            }),
            ...
            (t.prototype.cancelSearch = function (e) {
              var t = this.$editor;
              return (
            ...
            (t.prototype.highlightAndFindWithNeedle = function (e, t) {
            ...
            (t.prototype.addString = function (e) {
              return this.highlightAndFindWithNeedle(!1, function (t) {
                if (!f(t)) return t + e;
                var n = l(t);
                return ((n.expression += e), h(n));
              });
            }),
            (t.prototype.removeChar = function (e) {
              return this.highlightAndFindWithNeedle(!1, function (e) {
                if (!f(e)) return e.substring(0, e.length - 1);
                var t = l(e);
                return (
            ...
            (t.prototype.convertNeedleToRegExp = function () {
              return this.highlightAndFindWithNeedle(!1, function (e) {
                return f(e) ? e : c(e, "ig");
              });
            }),
            (t.prototype.convertNeedleToString = function () {
              return this.highlightAndFindWithNeedle(!1, function (e) {
                return f(e) ? l(e).expression : e;
              });
            }),
            (t.prototype.statusMessage = function (e) {
              var t = this.$options,
                n = "";
  ...
  define(
    ...
    function (e, t, n) {
      ...
      function a(e, t) {
        var n = e[e.length - 1];
        if (n && n.row === t.row && n.column === t.column) return;
        e.push(t);
      }
      var r = e("../lib/dom");
      ...
      ((t.handler.attach = function (e) {
        ((o = e.session.$selectLongWords),
          ...
          (e.pushEmacsMark = function (e, t) {
            ...
            (n && a(this.session.$emacsMarkRing, n),
              !e || t
                ? this.setEmacsMark(e)
                : a(this.session.$emacsMarkRing, e));
          }),
