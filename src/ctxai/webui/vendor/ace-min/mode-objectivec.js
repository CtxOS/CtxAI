      ...
      var r = e("../lib/oop"),
        ...
        u = function (e) {
          var t =
            ...
            a = (this.$keywords = this.createKeywordMapper(
              Object.assign(
                {
                  "keyword.control": t,
                  "storage.type": n,
      ...
      var r = e("../lib/oop"),
        ...
        o = function () {
          var e = {
            ...
            r = new s(e),
            o = r.getRules();
          ((this.$keywordList = r.$keywordList),
            (this.$rules = {
              start: [
                { token: "comment", regex: "\\/\\/.*$" },
                i.getStartRule("doc-start"),
              ...
              constant_NSString: [
                { token: "constant.character.escape.objc", regex: t },
                {
              ...
              bracketed_strings: [
                ...
                { regex: t, token: "constant.character.escape.objc" },
                {
                  regex: "\\\\.",
                  token: "invalid.illegal.unknown-escape.objc",
                },
          ...
          for (var u in o)
            this.$rules[u]
              ? this.$rules[u].push &&
                this.$rules[u].push.apply(this.$rules[u], o[u])
              : (this.$rules[u] = o[u]);
          ((this.$rules.bracketed_content =
            this.$rules.bracketed_content.concat(this.$rules.start, n)),
            this.embedRules(i, "doc-", [i.getEndRule("start")]));
        };
      (r.inherits(o, s), (t.ObjectiveCHighlightRules = o));
    },
  ),
  define(
