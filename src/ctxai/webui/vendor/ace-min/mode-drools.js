      ...
      var r = e("../lib/oop"),
        ...
        o = function () {
          ...
          ((this.$rules = {
                ...
                next: [
                  {
                    ...
                    token: "paren.lparen",
                    push: [
                      { regex: "}", token: "paren.rparen", next: "pop" },
                      { include: "comments" },
                      {
                        regex:
            ...
            this.embedRules(i, "doc-", [i.getEndRule("pop")]),
            this.normalizeRules());
        };
  ...
  define(
    ...
    function (e, t, n) {
      ...
      function a(e, t, n, r) {
        ...
        if (a > u) {
          var l = e.getLine(a).length;
          return new i(u, s, a, l);
        }
      }
      var r = e("../../lib/oop"),
        i = e("../../range").Range,
              ...
              if (t === "markbegin") {
                ...
                if (this.importRegex.test(r))
                  if (n === 0 || !this.importRegex.test(e.getLine(n - 1)))
                    return "start";
                if (this.globalRegex.test(r))
                  if (n === 0 || !this.globalRegex.test(e.getLine(n - 1)))
                    return "start";
              }
              return this.getBaseFoldWidget(e, t, n);
            }),
            (this.getFoldWidgetRange = function (e, t, n) {
              var r = e.getLine(n),
                s = r.match(this.foldingStartMarker);
              if (s && s[1]) {
                var u = { row: n, column: r.length },
                  f = new o(e, u.row, u.column),
                  l = "end",
                  c = f.getCurrentToken();
                c.value == "when" && (l = "then");
                while (c) {
                  if (c.value == l)
                    return i.fromPoints(u, {
              ...
              s = r.match(this.importRegex);
              if (s) return a(e, this.importRegex, s, n);
              s = r.match(this.globalRegex);
              if (s) return a(e, this.globalRegex, s, n);
            }));
        }.call(u.prototype));
    },
  ),
