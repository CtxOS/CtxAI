(define(
    ...
    var r = e("../lib/oop"),
      ...
      s = function () {
        ((this.$rules = {
          ...
          "#character_escapes": [
            { token: "constant.character.escape.newline.zig", regex: /\\n/ },
            {
              token: "constant.character.escape.carrigereturn.zig",
              regex: /\\r/,
            },
            { token: "constant.character.escape.tabulator.zig", regex: /\\t/ },
            { token: "constant.character.escape.backslash.zig", regex: /\\\\/ },
            {
          ...
          "#operators": [
            { token: "keyword.operator.zig", regex: /\b!\b/ },
            { token: "keyword.operator.logical.zig", regex: /==|(?:!|>|<)=?/ },
            { token: "keyword.operator.word.zig", regex: /\b(?:and|or)\b/ },
            {
          ...
          "#param_list": [
            {
              ...
              push: [
                ...
                { include: "#dummy_main" },
                { token: "storage.type.zig", regex: /[a-zA-Z_][\w.]*|@\".+\"/ },
              ],
            },
          ],
          "#punctuation": [
            { token: "punctuation.separator.zig", regex: /,/ },
            { token: "punctuation.terminator.zig", regex: /;/ },
            { token: "punctuation.section.parens.begin.zig", regex: /\(/ },
            { token: "punctuation.section.parens.end.zig", regex: /\)/ },
          ],
          "#storage": [
            {
            ...
            { token: "storage.type.function.zig", regex: /\bfn\b/ },
            { token: "storage.type.test.zig", regex: /\btest\b/ },
            { token: "storage.type.struct.zig", regex: /\bstruct\b/ },
            { token: "storage.type.enum.zig", regex: /\benum\b/ },
            { token: "storage.type.union.zig", regex: /\bunion\b/ },
            { token: "storage.type.error.zig", regex: /\berror\b/ },
          ],
          "#storage_modifier": [
            {
          ...
          "#strings": [
            {
              ...
              regex: /\'/,
              push: [
                { token: "string.quoted.single.zig", regex: /\'/, next: "pop" },
            ...
            },
            {
              ...
              regex: /c?\"/,
              push: [
                { token: "string.quoted.double.zig", regex: /\"/, next: "pop" },
                { include: "#character_escapes" },
                {
                  token: "invalid.illegal.character.zig",
                  regex: /\\[^\'][^\']*?/,
            ...
            },
            {
              ...
              regex: /c?\\\\/,
              push: [
                { token: "string.quoted.other.zig", regex: /$/, next: "pop" },
          ...
          "#variables": [
            { token: "variable.constant.zig", regex: /\b[_A-Z][_A-Z0-9]+\b/ },
            {
              token: "entity.name.type.zig",
              regex: /\b[_a-zA-Z][_a-zA-Z0-9]*_t\b/,
            },
            { token: "entity.name.type.zig", regex: /\b[A-Z][a-zA-Z0-9]*\b/ },
            { token: "variable.zig", regex: /\b[_a-zA-Z][_a-zA-Z0-9]*\b/ },
          ],
        }),
          this.normalizeRules());
      };
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        i = e("./text").Mode,
        s = e("./zig_highlight_rules").ZigHighlightRules,
      ...
      (r.inherits(u, i),
        function () {
          ((this.lineCommentStart = "//"), (this.$id = "ace/mode/zig"));
        }.call(u.prototype),
        (t.Mode = u));
    },
  ));
