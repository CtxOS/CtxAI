    ...
    (function (e, n, r) {
      ...
      function tt() {
        ...
        while (ct(t.charCodeAt(P)))
          (++P,
            P - n > 6 && O(null, w.tooLargeCodepoint, "\\" + t.slice(e, P)));
        var r = t.charAt(P++);
        r !== "}" &&
          (r === '"' || r === "'"
            ? O(null, w.braceExpected, "}", "\\" + t.slice(e, P--))
        ...
        var i = parseInt(t.slice(n, P - 1) || "0", 16),
          o = "\\" + t.slice(e, P);
        return (
          i > 1114111 && O(null, w.tooLargeCodepoint, o),
          s.encodeUTF8(i, o)
        );
      }
      function nt() {
        ...
        if (p === H.type)
          switch (H.value) {
            ...
            case "break":
              return (
                st(),
                e.isInLoop() || O(H, w.noLoopToBreak, H.value),
                It()
              );
            case "do":
              return (st(), Rt(e));
