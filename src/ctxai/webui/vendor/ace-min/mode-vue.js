          ...
          function (e, t, n) {
            if (n || arguments.length === 2)
              for (var r = 0, i = t.length, s; r < i; r++)
                if (s || !(r in t))
                  (s || (s = Array.prototype.slice.call(t, 0, r)),
                    (s[r] = t[r]));
            return e.concat(s || Array.prototype.slice.call(t));
          },
        s = e("../lib/oop"),
        o = e("./css_highlight_rules").CssHighlightRules,
        u = e("./typescript_highlight_rules").TypeScriptHighlightRules,
        a = e("./coffee_highlight_rules").CoffeeHighlightRules,
        f = e("./html_highlight_rules").HtmlHighlightRules,
        l = e("./javascript_highlight_rules").JavaScriptHighlightRules,
        c = e("./stylus_highlight_rules").StylusHighlightRules,
        h = e("./sass_highlight_rules").SassHighlightRules,
        p = e("./scss_highlight_rules").ScssHighlightRules,
        d = e("./less_highlight_rules").LessHighlightRules,
        v = e("../tokenizer").Tokenizer,
        m = e("./slim_highlight_rules").SlimHighlightRules,
        g = e("./jade_highlight_rules").JadeHighlightRules,
        y = e("./javascript").Mode,
        b = function (e) {
          this.embedLangRules = function (e, t, n, r) {
            var i = r
              ? "(?=[^>]*" + r + "\\s*=\\s*['\"]" + n + "['\"]))"
              : "(?=\\s|>|$))";
            (this.$rules.start.unshift({
              token: [
                "meta.tag.punctuation.tag-open.xml",
                "meta.tag." + t + ".tag-name.xml",
              ],
              regex: "(<)(" + t + i,
              next: [
                {
                  token: "meta.tag.punctuation.tag-close." + t + ".xml",
                  regex: "/?>",
                  next: n + "-start",
                },
                { include: "attributes" },
          ...
          var t = [{ include: "vue-interpolations" }],
            n = new f().getRules();
          ((n.start = t.concat(n.start)),
            (n["vue-interpolations"] = [
              {
                token: "punctuation",
                regex: /\{\{\{?/,
          ...
          (n.tag_stuff.unshift(
            {
              ...
              onMatch: function (e, t, n) {
                var r = e[e.length - 1];
                n.unshift(r, t);
                var i = new RegExp(this.regex).exec(e);
                if (!i) return "text";
                var s = [],
                  o = [
                ...
                for (var u = 0, a = o.length; u < a; u++)
                  i[u + 1] && (s[s.length] = { type: o[u], value: i[u + 1] });
                return s;
              },
              next: [
                { token: "string", regex: /$/, next: "tag_stuff" },
                {
                  token: "string",
                  regex: /.*/,
                  onMatch: function (e, t, n, o) {
                    ...
                    if (a.length > 1) {
                      n.shift();
                      var l = n.shift(),
                        c = new v(s.$rules).getLineTokens(
                          a.slice(1).join(u),
                          l,
                        );
                      (c.tokens.unshift({ type: "string", value: u }),
                        (this.next = Array.isArray(c.state)
                          ? c.state[c.state.length - 1]
                          : c.state));
                    }
                    var h = new y().getTokenizer().getLineTokens(f, "start"),
                      p = h.tokens;
                    return (c && p.push.apply(p, i([], r(c.tokens), !1)), p);
                  },
                },
              ],
            },
            ...
            (this.$rules = n),
            this.embedRules(l, "js-interpolation-", [
              { token: "punctuation", regex: /\}\}\}?/, next: "start" },
            ]),
            this.embedLangRules(o, "style", "css"),
            this.embedLangRules(c, "style", "stylus", "lang"),
            this.embedLangRules(h, "style", "sass", "lang"),
            this.embedLangRules(p, "style", "scss", "lang"),
            this.embedLangRules(d, "style", "less", "lang"),
            this.embedLangRules(u, "script", "ts", "lang"),
            this.embedLangRules(a, "script", "coffee", "lang"),
            this.embedLangRules(m, "template", "slm", "lang"),
            this.embedLangRules(g, "template", "jade", "lang"),
            this.embedLangRules(c, "template", "stylus", "lang"),
            this.normalizeRules());
        };
      (s.inherits(b, f), (t.VueHighlightRules = b));
    },
  ),
  define(
    "ace/mode/vue",
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        ...
        a = e("./html").Mode,
        f = e("./vue_highlight_rules").VueHighlightRules,
        l = [
          "area",
          "base",
          "br",
        ...
        h = function () {
          ((this.HighlightRules = f),
            (this.foldingRules = new i(this.voidElements, s.arrayToMap(c))),
      ...
      (r.inherits(h, a),
        function () {
          ((this.blockComment = { start: "<!--", end: "-->" }),
            (this.voidElements = s.arrayToMap(l)),
            (this.getCompletions = function (e, t, n, r) {
              return this.$completer.getCompletions(e, t, n, r);
            }),
