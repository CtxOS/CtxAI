(define(
  ...
  function (e, t, n) {
        ...
        ((this.$rules = {
          start: [
            ...
            },
            {
              ...
              regex:
                /\b0[xX][0-9A-Fa-f]+(?:\.[0-9A-Fa-f]+)?(?:[eE]-?\d*)?(?:[pP][-+]\d+)?\b/,
            },
            {
            ...
            { token: "comment.line.double-dash.clue", regex: /\/\/.*/ },
            {
            ...
            { token: "constant.language.ellipsis.clue", regex: /\.{3}(?!\.)/ },
            {
            ...
            { token: "variable.language.self.clue", regex: /\bself\b/ },
            {
              token: "support.function.any-method.clue",
              regex: /\b[a-zA-Z_][a-zA-Z0-9_]*\b(?=\(\s*)/,
            },
            { token: "variable.other.clue", regex: /[A-Za-z_][0-9A-Za-z_]*/ },
          ],
          "#escaped_char": [
            {
            ...
            { token: "invalid.illegal.character.escape.clue", regex: /\\./ },
          ],
          property_identifier: [
            {
    ...
    ((s.metaData = { name: "Clue", scopeName: "source.clue" }),
      r.inherits(s, i),
      (t.ClueHighlightRules = s));
  },
),
  define(
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        i = e("./text").Mode,
        s = e("./clue_highlight_rules").ClueHighlightRules,
