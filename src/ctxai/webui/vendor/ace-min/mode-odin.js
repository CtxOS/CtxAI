(define(
  ...
  define(
    ...
    function (e, t, n) {
            ...
            n = i(
              i(
                i(
                  ...
                  r(t(["f"], ["16", "32", "64"], ["", "le", "be"])),
                  !1,
                ),
                r(t(["complex"], ["32", "64", "128"])),
                !1,
              ),
              r(t(["quaternion"], ["64", "128", "256"])),
              !1,
            ).join("|"),
            s = [
              "\\*",
              ...
              .concat("=", ":=", "::", "->", "\\^", "&", ":")
              .join("|"),
            u = "new|cap|copy|panic|len|make|delete|append|free",
            a = "nil|true|false",
            f = this.createKeywordMapper(
              {
                keyword: e,
                "constant.language": a,
                "support.function": u,
              ...
              },
              {
                token: function (e) {
                  return e[e.length - 1] == "("
                    ? [
                        {
                          type: f(e.slice(0, -1)) || "support.function",
                          value: e.slice(0, -1),
                        },
      ...
      (s.inherits(a, u), (t.OdinHighlightRules = a));
    },
  ),
  define(
  ...
  define(
    ...
    function (e, t, n) {
      var r = e("../lib/oop"),
        i = e("./text").Mode,
        s = e("./odin_highlight_rules").OdinHighlightRules,
