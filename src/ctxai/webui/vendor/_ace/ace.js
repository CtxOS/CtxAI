  ...
  define(
    ...
    function (e, t, n) {
      ...
      function c(e) {
        ...
        function c(e) {
          ...
          if (
            e &&
            e.type === "mouseout" &&
            (!e.relatedTarget || r.getElement().contains(e.relatedTarget))
          )
            return;
          (i && (i = clearTimeout(i)),
            r.isOpen &&
        ...
        (e.editor.setDefaultHandler("guttermousemove", function (t) {
          ...
          if (
            s.hasCssClass(n, "ace_fold-widget") ||
            s.hasCssClass(n, "ace_custom-widget")
          )
            return c();
      ...
      var h = (function (e) {
        function t(n, r) {
          r === void 0 && (r = !1);
          var i = e.call(this, n.container) || this;
          ((i.id = "gt" + ++t.$uid), (i.editor = n), i.visibleTooltipRow);
          var s = i.getElement();
          return (
            ...
            r &&
              ...
              s.addEventListener("mouseout", i.onMouseOut)),
            i
          );
        }
        return (
          ...
          (t.prototype.showTooltip = function (e) {
            ...
            if (u && r.$showFoldedAnnotations) {
              var a = {
                ...
                f = { error: 1, security: 2, warning: 3, info: 4, hint: 5 },
                l;
            ...
            for (var c = 0; c < o.displayText.length; c++) {
              ...
              ((n = y.classList).add.apply(n, ["ace_".concat(o.type[c]), m]),
                y.setAttribute(
                  "aria-label",
                  "".concat(
                    t.annotationLabels[o.type[c].replace("_fold", "")].singular,
                  ),
                ),
            ...
            var w = this.$findLinkedAnnotationNode(e);
            (w && w.setAttribute("aria-describedby", this.id),
              this.show(),
          ...
          (t.prototype.hideTooltip = function () {
            if (!this.isOpen) return;
            (this.$element.removeAttribute("aria-live"), this.hide());
            if (this.visibleTooltipRow != undefined) {
              var e = this.$findLinkedAnnotationNode(this.visibleTooltipRow);
            ...
            set: function (e) {
              ...
              e
                ...
                : (T.removeListener(n, "keydown", this.$readOnlyCallback),
                  ...
                  this.hoverTooltip &&
                    (this.hoverTooltip.destroy(), (this.hoverTooltip = null)));
            },
            initialValue: !1,
          },
