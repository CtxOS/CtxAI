...
class WebSocketHandler(ABC):
    ...
    The interface mirrors :class:`ctxai.utils.ctxai.api.routers.system.ApiHandler` with declarative
    ...
    def __init__(self, socketio: AsyncServer, lock: threading.RLock) -> None:
        ...
        self.socketio: AsyncServer = socketio
