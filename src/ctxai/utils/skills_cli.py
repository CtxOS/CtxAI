...
Usage:
    python -m ctxai.utils.skills_cli list              List all skills
    python -m ctxai.utils.skills_cli create <name>     Create a new skill
    python -m ctxai.utils.skills_cli show <name>       Show skill details
    python -m ctxai.utils.skills_cli validate <name>   Validate a skill
    python -m ctxai.utils.skills_cli search <query>    Search skills
"""
  ...
  %(prog)s search python            Search for skills
    ...
    if args.command == "list":
        ...
        try:
            ...
            print(f"  3. Run: python -m ctxai.utils.skills_cli validate {args.name}")
