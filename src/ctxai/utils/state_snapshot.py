...
from ctxai.core.agent import AgentContext, AgentContextType
from ctxai.utils.dotenv import get_dotenv_value
...
async def build_snapshot_from_request(*, request: StateRequestV1) -> SnapshotV1:
    ...
    snapshot: SnapshotV1 = {
        ...
        "log_progress_active": bool(active_context.log.progress_active)
        if active_context
        else False,
