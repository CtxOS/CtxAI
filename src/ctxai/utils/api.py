...
from ctxai.utils import cache, files, plugins
from ctxai.utils.errors import format_error
...
Input = dict
Output = dict[str, Any] | Response | Any  # type: ignore[assignment]
...
def register_api_route(app: Flask, lock: ThreadLockType) -> None:
    from ctxai.utils.extract_tools import load_classes_from_file
