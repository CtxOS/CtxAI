...
"""
    ...
    async def inspect_backup(self, backup_file) -> dict[str, Any]:
        ...
        try:
            ...
            raise Exception("Invalid backup file: not a valid zip archive") from e
        except json.JSONDecodeError as e:
            raise Exception("Invalid backup file: corrupted metadata") from e
        finally:
            # Cleanup
            ...
            with zipfile.ZipFile(temp_file, "r") as zipf:
                ...
                for archive_path in archive_files:
                    ...
                    try:
                        ...
                        errors.append(
                            {"path": archive_path, "original_path": original_path, "error": str(e)}
                        )
