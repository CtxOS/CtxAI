...
Import and call from your store; do not render a dedicated error/success block in the template. See [Notifications](/ctx/docs/developer/notifications.md) for the full API.
...
### Import Paths
- Correct: `from ctxai.agent import AgentContext, AgentContextType`
- Correct: `from ctxai.initialize import initialize_agent`

### Sending Messages Proactively
```python
from ctxai.agent import AgentContext
from ctxai.helpers.messages import UserMessage
...
```python
from ctxai.helpers.plugins import get_plugin_config, save_plugin_config
