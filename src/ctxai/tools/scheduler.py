...
class SchedulerTool(Tool):
    ...
    async def list_tasks(self, **kwargs) -> Response:
        ...
        for task in tasks:
            ...
            if next_run_within_filter is not None and next_run is not None and next_run > next_run_within_filter:
                continue
            if next_run_after_filter is not None and next_run is not None and next_run < next_run_after_filter:
                continue
