...
from ctxai.shared import history as history_helpers
from ctxai.shared.errors import HandledException
from langchain_core.messages import AIMessage, HumanMessage, SystemMessage

if TYPE_CHECKING:
    from ctxai.agent import Agent
    from ctxai.shared.log import LogItem
...
class InfectionChecker:
    ...
    def _do_terminate(self, agent: "Agent", detail: str, cot: str):
        ...
        from ctxai.shared.notification import (
            NotificationManager,
            NotificationType,
