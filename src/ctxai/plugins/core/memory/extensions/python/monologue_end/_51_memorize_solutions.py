...
from ctxai.plugins.core.memory.tools.memory_load import (
    DEFAULT_THRESHOLD as DEFAULT_MEMORY_THRESHOLD,
)
from ctxai.utils import errors, plugins
from ctxai.utils.defer import THREAD_BACKGROUND, DeferredTask
from ctxai.utils.dirty_json import DirtyJson
from ctxai.utils.extension import Extension
from ctxai.utils.log import LogItem
            ...
            for solution in solutions:
                ...
                if set["memory_memorize_consolidation"]:
                    try:
                        ...
                        from ctxai.plugins.core.memory.helpers.memory_consolidation import (
