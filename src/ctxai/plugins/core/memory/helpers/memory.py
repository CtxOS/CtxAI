...
from ctxai.core.agent import Agent, AgentContext

# faiss needs to be patched for python 3.12 on arm #TODO remove once not needed
from ctxai.utils import files, guids, plugins, projects
...
def abs_db_dir(memory_subdir: str) -> str:
    ...
    if memory_subdir.startswith("projects/"):
        from ctxai.utils.projects import get_project_meta
...
def get_existing_memory_subdirs() -> list[str]:
    try:
        from ctxai.utils.projects import (
            get_project_meta,
