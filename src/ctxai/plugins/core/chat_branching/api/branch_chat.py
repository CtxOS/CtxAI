...
from ctxai.utils.api import ApiHandler, Input, Output, Request, Response
from ctxai.utils.persist_chat import (
...
class BranchChat(ApiHandler):
    ...
    async def process(self, input: Input, request: Request) -> Output:
        ...
        mark_dirty_all(reason="ctxai.plugins.core.chat_branching.BranchChat")
