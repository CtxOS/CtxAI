...
class TunnelManager:
    ...
    def _on_notify(self, data: NotifyData):
        ...
        self.notifications.append({"event": data.event.value, "message": data.message, "data": data.data})
        ...
        try:
            ...
            def run_tunnel():
                try:
                    ...
                    self.notifications.append({"event": NotifyEvent.ERROR.value, "message": error_msg, "data": None})
