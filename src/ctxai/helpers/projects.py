...
def _normalize_subagents(subagents_data: dict[str, SubAgentSettings]) -> dict[str, SubAgentSettings]:
...
def load_project_secrets_masked(name: str, merge_with_global=False):
    from ctxai.helpers import secrets
...
def save_project_secrets(name: str, secrets: str):
    from ctxai.helpers.secrets import get_project_secrets_manager
