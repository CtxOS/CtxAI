...
from ctxai.core.agent import AgentConfig
from ctxai.core.runtime import runtime
from ctxai.utils import defer, extension, settings
...
def initialize_agent(override_settings: dict | None = None):
    ...
    # import ctxai.core.agent as agent as agent_helper
    # import ctxai.utils.print_style as print_style_helper
...
def initialize_mcp():
    ...
    async def initialize_mcp_async():
        from ctxai.utils.mcp_handler import initialize_mcp as _initialize_mcp
...
def initialize_job_loop():
    from ctxai.utils.job_loop import run_loop
...
def initialize_preload():
    from ctxai.core import preload
...
def initialize_migration():
    from ctxai.utils import dotenv, migration
