...
from ctxai.shared import settings, projects
...
from ctxai.shared.persist_chat import remove_chat
    ...
    def _configure(self):
        ...
        try:
            ...
            provider: AgentProvider = {  # type: ignore
                "organization": "Ctx AI",
                "url": "https://github.com/ctxos/ctxai",
            }
                ...
                async def receive_wrapper():
                    ...
                    if message["type"] == "http.request" and not message.get("more_body", False) and not body_modified:
                        ...
                        try:
                            ...
                            body_parts = [
                                msg.get("body", b"") for msg in received_messages if msg["type"] == "http.request"
                            ]
