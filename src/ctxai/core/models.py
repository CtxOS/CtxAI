...
from ctxai.utils import browser_use_monkeypatch, dirty_json, dotenv, settings
from ctxai.utils.dotenv import load_dotenv
from ctxai.utils.providers import ModelType as ProviderModelType
from ctxai.utils.providers import get_provider_config
from ctxai.utils.rate_limiter import RateLimiter
from ctxai.utils.tokens import approximate_tokens
...
load_dotenv()
turn_off_logging()
# browser_use_monkeypatch.apply() # MOVED to where it is needed or made lazy
