...
from ctxai.shared.skills import discover_skill_md_files


ConflictPolicy = Literal["skip", "overwrite", "rename"]

# Project skills folder name (inside .ctxaiproj)
...
def _unzip_to_temp_dir(zip_path: Path) -> Path:
    ...
    """
    base_tmp = Path(files.get_abs_path(files.TMP_DIR, "skill_imports"))
