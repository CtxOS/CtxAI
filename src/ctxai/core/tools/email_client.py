...
from ctxai.shared.errors import RepairableException, format_error
...
class EmailClient:
    ...
    async def read_messages(
        ...
        Args:
            download_folder: Folder to save attachments (relative to /ctxai/)
    ...
    def _html_to_text(self, html_content: str, cid_map: Optional[Dict[str, str]] = None) -> str:
        ...
        Replaces inline images with [file:///ctxai/...] markers to maintain
        positional context.
        """
        cid_map = cid_map or {}
...
async def read_messages(
    ...
    username: str = "",
    password: str = "",
    download_folder: str = os.path.join(files.USER_DIR, "email"),
    options: Optional[Dict[str, Any]] = None,
    filter: Optional[Dict[str, Any]] = None,
) -> List[Message]:
    """
