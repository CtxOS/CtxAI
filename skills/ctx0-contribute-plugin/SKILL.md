...
This skill guides publishing a plugin to the [Plugin Index](https://github.com/ctxos/ctx0-plugins), making it discoverable and installable by all CtxAI users.
...
```
https://github.com/ctxos/ctx0-plugins/releases/download/generated-index/index.json
```
...
```bash
# Automatic mode
gh repo fork https://github.com/ctxos/ctx0-plugins --clone --remote
cd ctx0-plugins
...
Use tags from https://github.com/ctxos/ctx0-plugins/blob/main/TAGS.md (up to 5).
...
- Plugin Index repo: https://github.com/ctxos/ctx0-plugins
- Recommended tags: https://github.com/ctxos/ctx0-plugins/blob/main/TAGS.md
