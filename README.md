...
A detailed setup guide for Windows, macOS, and Linux using `uv` or `docker` can be found in the Agent Zero Documentation at [this page](./docs/setup/installation.md).
