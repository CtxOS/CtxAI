...
- **Automated configuration** via `CTXAI_SET_` environment variables for deployment automation and easy setup.
...
- Environment variables can now configure settings via `CTXAI_SET_*` prefix in `.env`
