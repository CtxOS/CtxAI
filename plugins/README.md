...
The **Plugin Index** at https://github.com/ctxos/ctx0-plugins is the community-maintained registry of plugins available to all CtxAI users.
...
2. Fork `https://github.com/ctxos/ctx0-plugins` and add a folder `plugins/<your_plugin_name>/` containing a separate index manifest named `index.yaml` (not `plugin.yaml`):
