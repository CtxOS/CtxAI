...
The **Plugin Index** is a community-maintained repository at https://github.com/ctxos/ctx0-plugins that lists plugins available to the CtxAI community. Plugins listed there can be discovered and installed by other users.
...
- `tags`: optional, up to 5, use recommended tags from https://github.com/ctxos/ctx0-plugins/blob/main/TAGS.md
