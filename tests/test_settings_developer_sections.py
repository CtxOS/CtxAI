...
def test_websocket_harness_entrypoint_is_present_in_developer_settings_template():
    dev_template_path = PROJECT_ROOT / "src" / "ctxai" / "webui" / "components" / "settings" / "developer" / "dev.html"
...
def test_websocket_harness_template_is_gated_by_runtime():
    template_path = (
        PROJECT_ROOT / "src" / "ctxai" / "webui" / "components" / "settings" / "developer" / "websocket-tester.html"
    )
